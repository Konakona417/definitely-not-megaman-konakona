...
public class GraphicsManager {
	...
	private BufferedImage brinstarImg;
	private BufferedImage gloombrinstarImg;
	private BufferedImage variabrinstarImg;
	...
	public GraphicsManager(){
		...
		try {
			...
			this.brinstarImg = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/Radioactive Tower.bmp"));
			this.gloombrinstarImg = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/Gloomy Old Brinstar.bmp"));
			this.variabrinstarImg = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/Varia Suit Room.bmp"));
			this.enemyImg = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/metroid.png"));
	...
	public void drawEnemy(Enemy enemy, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(enemyImg, 300, 300, observer);
	}
	...
	public void drawBackground(Background brinstar, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(brinstarImg, 0, 0, observer);
	}
	public void drawgloomBackground(Background gloombrinstar, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(gloombrinstarImg, 0, 0, observer);
	}
	public void drawvariaBackground(Background variabrinstar, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(variabrinstarImg, 0, 0, observer);
	}
